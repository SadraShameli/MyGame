...
namespace MyGame
{
	...
	class DescriptorAllocator : public DirectXImpl
	{
	public:
	...
	class DescriptorHandle : public DirectXImpl
	{
	public:
		DescriptorHandle()
		{
	...
	class DescriptorHeap : public DirectXImpl
	{
	public:
		DescriptorHeap() {}
	...
	class RootSignature;
	class DynamicDescriptorHeap : public DirectXImpl
	{
	public:
